...
export const liburanKeluargaData: LandingPageData = {
  hero: {
    title: "Umroh Liburan Keluarga & Akhir Tahun 2026",
    subtitle: "Jadikan libur semester akhir tahun 2026 sebagai momen spiritual tak terlupakan bagi keluarga. Hadirkan edukasi Islami bagi anak dengan paket umroh khusus keluarga mulai Rp27 Jutaan.",
  ...
  valueProposition: {
    ...
    features: [
      ...
      { icon: '💰', title: 'Harga Terjangkau', description: 'Nikmati penawaran paket keluarga hemat mulai dari Rp27 Jutaan, sebuah solusi cerdas untuk liburan yang menyenangkan sekaligus bernilai ibadah.' },
      { icon: '🗓️', title: 'Waktu Ideal', description: 'Jadwal keberangkatan yang dirancang khusus bertepatan dengan libur semester akhir tahun (November - Desember 2026), beribadah tenang tanpa memotong jam sekolah anak.' },
  ...
  problemAgitation: {
    title: "Libur Sekolah Tiba, Sekadar Liburan Biasa atau Mengejar Keberkahan?",
    description: "Seringkali liburan sekolah akhir tahun berlalu begitu saja atau hanya habis untuk bermain gadget di rumah. Tahun 2026 ini, ciptakan momen berbeda yang mendidik dan menyejukkan hati melalui Paket Umroh Liburan Keluarga.",
  ...
  faq: [
    { question: "Apakah jadwalnya pasti pas liburan sekolah?", answer: "Ya, kami menyusun jadwal keberangkatan di bulan November dan Desember 2026 agar bertepatan dengan masa libur semester ganjil anak-anak." },
  ...
  cta: {
    ...
    description: "Seat liburan sekolah akhir tahun sangat cepat terisi karena High Season. Amankan kuota umroh bersama keluarga Anda sekarang sebelum kehabisan.",
