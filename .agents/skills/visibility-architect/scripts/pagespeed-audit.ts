...
if (!url) {
  console.error('Usage: PAGESPEED_API_KEY=<key> bun pagespeed-audit.ts <url> [strategy]');
  console.error('Example: PAGESPEED_API_KEY=AIzaSy... bun pagespeed-audit.ts https://example.com desktop');
  process.exit(1);
}
